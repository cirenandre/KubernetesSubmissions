...
Exercise submissions for the DevOps with Kubernetes course. There is one
directory per application; see each application's own README.md for how to
run it.
...
- 1.7. [log_output](https://github.com/cirenandre/KubernetesSubmissions/tree/1.7/log_output)
- 1.8. [todo-app](https://github.com/cirenandre/KubernetesSubmissions/tree/1.8/todo-app)
...
- 2.5. [log_output](https://github.com/cirenandre/KubernetesSubmissions/tree/2.5/log_output)
- 2.6. [todo-app & todo-backend](https://github.com/cirenandre/KubernetesSubmissions/tree/2.6)
- 2.7. [ping-pong](https://github.com/cirenandre/KubernetesSubmissions/tree/2.7/ping-pong)
...
- 3.8. [project](https://github.com/cirenandre/KubernetesSubmissions/tree/3.8/project)
